...
date: "2025-08-04"
description: "We are thrilled to release **Qwen-Image**, a 20B MMDiT image foundation model that achieves significant advances in complex text rendering and precise image editing. To try the latest model, feel free to visit [Qwen Chat](https://chat.qwenlm.ai) and choose “Image Generation”."
---
...
<LinkButton href="https://huggingface.co/Qwen/Qwen-Image" label="HUGGING FACE" external />
<LinkButton href="https://modelscope.cn/models/Qwen/Qwen-Image" label="MODELSCOPE" external />
<LinkButton href="https://modelscope.cn/aigc/imageGeneration?tab=advanced" label="DEMO" external />
