...
date: "2025-09-23"
description: "We are excited to introduce Qwen3Guard, the first safety guardrail model in the Qwen family. Built upon the powerful Qwen3 foundation models and fine-tuned specifically for safety classificatoin, Qwen3Guard ensures responsible AI interactions by delivering precise safety detection for both prompts a"
---


<Figure src="https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen3Guard/banner.png" alt="Qwen3 Main Image" width="100%" />

<LinkButton href="https://github.com/QwenLM/Qwen3Guard/blob/main/Qwen3Guard_Technical_Report.pdf" label="Tech Report" external />
<LinkButton href="https://github.com/QwenLM/Qwen3Guard" label="GitHub" external />
<LinkButton href="https://huggingface.co/collections/Qwen/qwen3guard-68d2729abbfae4716f3343a1" label="Hugging Face" external />
<LinkButton href="https://modelscope.cn/collections/Qwen3Guard-308c39ef5ffb4b" label="ModelScope" external />
