...
date: "2024-08-29"
description: "After a year's relentless efforts, today we are thrilled to release **zen-VL**! zen-VL is the latest version of the vision language models based on **zen** in the Qwen model familities. Compared with Qwen-VL, zen-VL has the capabilities of:"
---

<Figure src="https://qianwen-res.oss-accelerate.aliyuncs.com/zen-VL/qwen2vl-head.jpeg#center" width="100%" />

<LinkButton href="https://huggingface.co/spaces/Qwen/zen-VL" label="DEMO" external />
<LinkButton href="https://github.com/QwenLM/zen-VL" label="GITHUB" external />
<LinkButton href="https://huggingface.co/collections/Qwen/qwen2-vl-66cee7455501d7126940800d" label="HUGGING FACE" external />
<LinkButton href="https://modelscope.cn/organization/qwen" label="MODELSCOPE" external />
<LinkButton href="https://help.aliyun.com/zh/model-studio/developer-reference/qwen-vl-api" label="API" external />
...
<Fullwidth>
{/* Interactive example: cases/1_3.json */}
{/* Interactive example: cases/1_4.json */}
{/* Interactive example: cases/1_6.json */}
{/* Interactive example: cases/1_7.json */}
{/* Interactive example: cases/1_1.json */}
{/* Interactive example: cases/1_5.json */}
</Fullwidth>
...
<Fullwidth>
{/* Interactive example: cases/2_2.json */}
{/* Interactive example: cases/2_1.json */}
{/* Interactive example: cases/2_3.json */}
{/* Interactive example: cases/2_4.json */}
{/* Interactive example: cases/2_5.json */}
{/* Interactive example: cases/2_6.json */}
{/* Interactive example: cases/2_7.json */}
</Fullwidth>
...
<Fullwidth>
{/* Interactive example: cases/3_1.json */}
{/* Interactive example: cases/3_2.json */}
</Fullwidth>


<Fullwidth>
{/* Interactive example: cases/3_3.json */}
{/* Interactive example: cases/3_4.json */}
</Fullwidth>
...
<Fullwidth>
{/* Interactive example: cases/4_1.json */}
{/* Interactive example: cases/4_2.json */}
{/* Interactive example: cases/4_7.json */}
{/* Interactive example: cases/4_8.json */}
</Fullwidth>
...
<Fullwidth>
{/* Interactive example: cases/4_3.json */}
{/* Interactive example: cases/4_4.json */}
{/* Interactive example: cases/4_5.json */}
{/* Interactive example: cases/4_6.json */}
</Fullwidth>
