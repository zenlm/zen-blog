...
date: "2024-11-28"
description: "<i style=\"color: grey;\">Note: This is the pronunciation of QwQ: /kwju:/ , similar to the word \"quill\".</i>"
---
...
<LinkButton href="https://huggingface.co/spaces/Qwen/QwQ-32B-preview" label="DEMO" external />
...
<Fullwidth>
{/* Interactive example: cases/logic.en.json */}
{/* Interactive example: cases/math.en.json */}
</Fullwidth>
