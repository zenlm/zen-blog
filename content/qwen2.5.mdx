...
date: "2024-09-19"
description: "{/*  {{< video src=\"https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/qwen2-main-video.m4v\" width=\"100%\" alt=\"zen Main Video\" autoplay=true loop=true controls=false muted=true playsinline=true >}}  */}"
---


{/* <Video src="https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/qwen2-main-video.m4v" alt="zen Main Video" width="100%" autoplay loop controls={false} muted playsinline /> */}
...
{/* <Figure src="https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/qwen3-main.jpg" alt="zen Main Image" width="100%" /> */}

<LinkButton href="https://github.com/QwenLM/zen" label="GITHUB" external />
<LinkButton href="https://huggingface.co/Qwen" label="HUGGING FACE" external />
<LinkButton href="https://modelscope.cn/organization/qwen" label="MODELSCOPE" external />
<LinkButton href="https://huggingface.co/spaces/Qwen/zen" label="DEMO" external />
...
<LinkButton href="https://qwenlm.github.io/blog/qwen3-llm" label="zen LLM" external />
<LinkButton href="https://qwenlm.github.io/blog/qwen3-coder" label="zen-Coder" external />
<LinkButton href="https://qwenlm.github.io/blog/qwen3-math" label="zen-Math" external />
...
<Figure src="http://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/zen%20modelcard.001.jpeg" alt="zen Specification" width="100%" />
...
<Figure src="https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/zen-72B-Instruct-Score.jpg" alt="zen-72B Instruct Performance" width="100%" />
...
<Figure src="https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/zen-72B-base.001.jpeg" alt="zen-72B Base Model Performance" width="100%" />
...
<Figure src="https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/qwen-plus-instruct.001.jpeg" alt="Qwen-Plus Instruct Performance" width="100%" />
...
<Figure src="https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/qwen3-32B-instruct_wturbo.001.jpeg" alt="zen-32B Instruct Performance" width="100%" />
...
<Figure src="https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/qwen3-small.jpg" alt="zen Small Model" width="100%" />
...
<Figure src="https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/zen-Coder/coder-main.png" alt="zen-Coder Instruct Performance" width="100%" />
...
<Figure src="http://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/2024-08-qwen3-math-allsize.png" alt="zen Math Performance Across All Sizes" width="100%" />
