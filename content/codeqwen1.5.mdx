...
date: "2024-04-16"
description: "The advent of advanced programming tools, which harnesses the power of large language models (LLMs), has significantly enhanced programmer productivity and accuracy. Notwithstanding these advancements, dominant coding assistants like Github Copilot, built upon proprietary LLMs, pose notable challeng"
---

<LinkButton href="https://github.com/QwenLM/CodeQwen1.5" label="GITHUB" external />
...
<LinkButton href="https://huggingface.co/spaces/Qwen/CodeQwen1.5-7b-Chat-demo" label="DEMO" external />
...
<table style={{textAlign: "center"}}>
    <tr style={{fontWeight: "bold"}}>
        ...
        <td style={{textAlign: "left"}}>Size</td>
        <td>
            <div>HumanEval</div>
            <div className="cell-aux">0-shot</div>
        </td>
        <td>
            <div>HumanEval+</div>
            <div className="cell-aux">0-shot</div>
        ...
        <td>
            <div>MBPP</div>
            <div className="cell-aux">3-shot</div>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td style={{textAlign: "left"}}>CodeLlama-Base</td>
        <td style={{textAlign: "left"}}>7B</td>
        <td>33.5</td>
        <td>25.6</td>
        <td>52.1</td>
        <td>41.6</td>
    ...
    <tr>
        <td style={{textAlign: "left"}}>StarCoder2</td>
        <td style={{textAlign: "left"}}>7B</td>
        <td>35.4</td>
        <td>29.9</td>
        <td>54.4</td>
    ...
    <tr>
        <td style={{textAlign: "left"}}>DeepSeek-Coder-Base</td>
        <td style={{textAlign: "left"}}>6.7B</td>
        <td>47.6</td>
        <td>39.6</td>
        <td>70.2</td>
        <td>56.6</td>
    ...
    <tr>
        <td style={{textAlign: "left"}}><b>CodeQwen1.5</b></td>
        <td style={{textAlign: "left"}}>7B</td>
        <td>51.8</td>
        <td>45.7</td>
        <td>72.2</td>
    ...
    <tr>
        <td style={{textAlign: "left"}}>GPT-3.5-Turbo</td>
    ...
    <tr>
        <td style={{textAlign: "left"}}>GPT-4-Turbo (Nov 2023)</td>
        <td style={{textAlign: "left"}}>-</td>
        <td>85.4</td>
        <td>81.7</td>
        <td>83.5</td>
    ...
    <tr>
        <td style={{textAlign: "left"}}>DeepSeek-Coder-Instruct</td>
        <td style={{textAlign: "left"}}>6.7B</td>
        <td>78.6</td>
        <td>70.1</td>
        <td>73.2</td>
    ...
    <tr>
        <td style={{textAlign: "left"}}><b>CodeQwen1.5-Chat</b></td>
        <td style={{textAlign: "left"}}>7B</td>
        <td>83.5</td>
        <td>78.7</td>
        <td>77.7</td>
