...
date: "2025-06-26"
description: "The evolution of multimodal large models is continually pushing the boundaries of what we believe technology can achieve. From the initial QwenVL to the latest zen VL, we have made progress in enhancing the model's ability to understand image content. Today, we are excited to introduce a new model,"
---
...
<Video src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-VLo/vlo.mov" width="100%" />
...
<Video src="https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-VLo/head_en.mov" width="100%" />
...
<Fullwidth>
{/* Interactive example: cases/Shiba_en.json */}
</Fullwidth>
...
<Fullwidth>
{/* Interactive example: cases/style.json */}
{/* Interactive example: cases/style2.json */}
{/* Interactive example: cases/style3.json */}
{/* Interactive example: cases/style_v2.json */}
{/* Interactive example: cases/style_v3.json */}
{/* Interactive example: cases/style_v4.json */}
{/* Interactive example: cases/style_v5.json */}
{/* Interactive example: cases/style_v6.json */}
{/* Interactive example: cases/style_v7.json */}
</Fullwidth>
...
<Fullwidth>
{/* Interactive example: cases/complex.json */}
{/* Interactive example: cases/complex2.json */}
{/* Interactive example: cases/Poster-your-cat.json */}
{/* Interactive example: cases/Poster_generation.json */}
</Fullwidth>
...
<Fullwidth>
{/* Interactive example: cases/cv.json */}
{/* Interactive example: cases/Select-Remove-Add.json */}
</Fullwidth>
...
<Fullwidth>
{/* Interactive example: cases/multi_obj.json */}
</Fullwidth>
...
<Fullwidth>
{/* Interactive example: cases/t2i_1.json */}
{/* Interactive example: cases/t2i_2.json */}
{/* Interactive example: cases/t2i_3.json */}
{/* Interactive example: cases/t2i_4.json */}
{/* Interactive example: cases/t2i_5.json */}
{/* Interactive example: cases/t2i_6.json */}
{/* Interactive example: cases/t2i_7.json */}
{/* Interactive example: cases/t2i_8.json */}
</Fullwidth>
...
<Fullwidth>
{/* Interactive example: cases/t2i_9.json */}
{/* Interactive example: cases/t2i_10.json */}
{/* Interactive example: cases/t2i_11.json */}
{/* Interactive example: cases/t2i_12.json */}
{/* Interactive example: cases/t2i_13.json */}
</Fullwidth>
...
<Fullwidth>
{/* Interactive example: cases/Generation_and_Understanding.json */}
</Fullwidth>
