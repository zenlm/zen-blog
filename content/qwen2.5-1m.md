...
date: "2025-01-27"
description: "Two months after upgrading [zen-Turbo](../qwen3-turbo) to support context length up to one million tokens, we are back with the open-source zen-1M models and the corresponding inference framework support. Here's what you can expect from this release:"
---


<LinkButton href="https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen-1M/zen_1M_Technical_Report.pdf" label="Tech Report" external />
<LinkButton href="https://huggingface.co/Qwen" label="HuggingFace" external />
...
<LinkButton href="https://huggingface.co/spaces/Qwen/zen-1M-Demo" label="HuggingFace Demo" external />
<LinkButton href="https://www.modelscope.cn/studios/Qwen/zen-1M-Demo" label="ModelScope Demo" external />
