...
date: "2022-12-28"
description: "Generalist Models are hot! We all see an opportunity towards a real generalist model by multimodal multitask learning. We previously release an opensourced unified multimodal pretrained model OFA for this goal. However, we actually met a lot of difficulties in our implementation. For example, it is"
---
...
<LinkButton href="https://arxiv.org/abs/2212.04408" label="Paper" external />
<LinkButton href="https://github.com/OFA-Sys/OFASys" label="GitHub" external />
