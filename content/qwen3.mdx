...
date: "2025-04-29"
description: "Today, we are excited to announce the release of **Qwen3**, the latest addition to the Qwen family of large language models. Our flagship model, **Qwen3-235B-A22B**, achieves competitive results in benchmark evaluations of coding, math, general capabilities, etc., when compared to other top-tier mod"
---
...
<Figure src="https://qianwen-res.oss-accelerate-overseas.aliyuncs.com/qwen3-banner.png" alt="Qwen3 Main Image" width="100%" />


<LinkButton href="https://chat.qwen.ai" label="QWEN CHAT" external />
<LinkButton href="https://github.com/QwenLM/Qwen3" label="GitHub" external />
<LinkButton href="https://huggingface.co/collections/Qwen/qwen3-67dd247413f0e2e4f653967f" label="Hugging Face" external />
<LinkButton href="https://modelscope.cn/collections/Qwen3-9743180bdc6b48" label="ModelScope" external />
<LinkButton href="https://www.kaggle.com/models/qwen-lm/qwen-3" label="Kaggle" external />
<LinkButton href="https://huggingface.co/spaces/Qwen/Qwen3-Demo" label="DEMO" external />
