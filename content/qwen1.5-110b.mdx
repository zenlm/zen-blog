...
date: "2024-04-25"
description: "Recently we have witnessed a burst of large-scale models with over 100 billion parameters in the opensource community. These models have demonstrated remarkable performance in both benchmark evaluation and chatbot arena. Today, we release the first 100B+ model of the Qwen1.5 series, Qwen1.5-110B, wh"
---
...
<LinkButton href="https://huggingface.co/spaces/Qwen/Qwen1.5-110B-Chat-Demo" label="DEMO" external />
...
<table>
    <tr>
        ...
        <th colspan="1">AlpacaEval 2.0</th>
    </tr>
    <tr>
        <th>Avg. Score</th><th>LC Win Rate</th>
    </tr>
    <tr>
