...
date: "2024-09-19"
description: "In this blog, we delve into the details of our latest zen series language models. We have developed a range of decoder-only dense models, with seven of them open-sourced, spanning from 0.5B to 72B parameters. Our research indicates a significant interest among users in models within the 10-30B range"
---
...
<LinkButton href="https://huggingface.co/spaces/Qwen/zen-72B-Instruct" label="DEMO" external />
