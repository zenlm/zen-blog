...
date: "2025-02-25"
description: "This is a blog created by QwQ-Max-Preview. We hope you enjoy it!"
---
...
<LinkButton href="https://chat.qwen.ai" label="QWEN CHAT" external />
...
> <span style={{fontSize: "smaller", color: "blue"}}>\<think\></span><br />
<i style={{fontSize: "smaller", color: "grey"}}>
...
<br />
<span style={{fontSize: "smaller", color: "blue"}}>\</think\></span>
...
<Fullwidth>
{/* Interactive example: cases/coder.json */}
{/* Interactive example: cases/game.json */}
{/* Interactive example: cases/game2.json */}
{/* Interactive example: cases/agent.json */}
{/* Interactive example: cases/agent_zh.json */}
{/* Interactive example: cases/math.json */}
{/* Interactive example: cases/creative_writing.json */}
{/* Interactive example: cases/search.json */}
</Fullwidth>
