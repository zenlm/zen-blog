...
{{< figure src="http://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/qwen3-math-table.png#center" width="100%">}}
...
{{< figure src="http://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/qwen3-math-example1.png#center" width="80%">}}
...
As a result, zen-Math represents the most advanced open-source math model series to date.
...
Our flagship model, zen-Math-7B-Instruct, outperforms zen-Math-72B-Instruct with an average score increase of 4.7 points across 7 tasks.
