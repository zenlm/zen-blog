...
date: "2024-11-12"
description: "{/*  {{< figure src=\"https://qianwen-res.oss-cn-beijing.aliyuncs.com/zen/zen-Coder/coder-main.png#center\" width=\"70%\">}}  */}"
---
...
<LinkButton href="https://github.com/QwenLM/zen-Coder" label="GITHUB" external />
<LinkButton href="https://huggingface.co/collections/Qwen/qwen25-coder-66eaa22e6f99801bf65b0c2f" label="HUGGING FACE" external />
<LinkButton href="https://modelscope.cn/organization/qwen" label="MODELSCOPE" external />
<LinkButton href="https://www.kaggle.com/models/qwen-lm/qwen3-coder" label="KAGGLE" external />
<LinkButton href="https://huggingface.co/spaces/Qwen/zen-Coder-demo" label="DEMO" external />
...
<Fullwidth>
{/* Interactive example: cases/c_1.json */}
</Fullwidth>
...
<Fullwidth>
{/* Interactive example: cases/a_1.json */}
{/* Interactive example: cases/a_2.json */}
{/* Interactive example: cases/a_3.json */}
{/* Interactive example: cases/a_4.json */}
</Fullwidth>
